...
export class Migration1782048405629 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Admin" ALTER COLUMN "mfaRecoveryCodeHashes" SET DEFAULT '[]'::jsonb`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Admin" ALTER COLUMN "mfaRecoveryCodeHashes" SET DEFAULT '[]'`);
