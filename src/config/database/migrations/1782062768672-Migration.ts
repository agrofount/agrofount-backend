...
export class Migration1782062768672 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "credit_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" numeric(10,2) NOT NULL, "action" character varying(50) NOT NULL, "notes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "creditFacilityId" uuid, CONSTRAINT "PK_1f23079c40e17baba72a8f83d41" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "ai_settings" ALTER COLUMN "costPer1MInputTokensUSD" SET DEFAULT '0.06'`);
        await queryRunner.query(`ALTER TABLE "ai_settings" ALTER COLUMN "costPer1MOutputTokensUSD" SET DEFAULT '0.24'`);
        ...
        await queryRunner.query(`ALTER TABLE "credit_history" ADD CONSTRAINT "FK_10630eac10287778cf5f22af205" FOREIGN KEY ("creditFacilityId") REFERENCES "credit_facility_request"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "credit_history" DROP CONSTRAINT "FK_10630eac10287778cf5f22af205"`);
